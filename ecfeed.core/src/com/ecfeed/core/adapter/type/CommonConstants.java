...
public class CommonConstants {
	...
	public static final String DEFAULT_NEW_ECT_FILE_NAME = DEFAULT_NEW_ECT_MODEL_NAME
			+ "." + EQUIVALENCE_CLASS_FILE_EXTENSION;
	...
	public static final String[] BOOLEAN_SPECIAL_VALUES = {
			BOOLEAN_TRUE_STRING_REPRESENTATION,
			BOOLEAN_FALSE_STRING_REPRESENTATION };
	public static final String[] INTEGER_SPECIAL_VALUES = {
