...
public class Messages {
	...
	public static final String DIALOG_RENAME_MODEL_PROBLEM_TITLE = "Cannot rename model";
	public static final String DIALOG_ADD_NEW_CLASS_PROBLEM_TITLE = "Cannot add new class";
	public static final String DIALOG_REMOVE_CLASSES_PROBLEM_TITLE = "Cannot remove classes";
	public static final String DIALOG_RENAME_CLASS_PROBLEM_TITLE = "Cannot rename class";
	public static final String DIALOG_MOVE_NODE_PROBLEM_TITLE = "Cannot move node";
	public static final String DIALOG_ADD_METHOD_PROBLEM_TITLE = "Cannot add new method";
	public static final String DIALOG_ADD_METHODS_PROBLEM_TITLE = "Cannot add all methods";
	public static final String DIALOG_REMOVE_METHOD_PROBLEM_TITLE = "Cannot remove requested method";
	public static final String DIALOG_REMOVE_METHODS_PROBLEM_TITLE = "Cannot remove some of requested methods";
	public static final String DIALOG_RENAME_METHOD_PROBLEM_TITLE = "Cannot rename method";
	public static final String DIALOG_CONVERT_METHOD_PROBLEM_TITLE = "Cannot convert method";
	public static final String DIALOG_UNEXPECTED_PROBLEM_WITH_TEST_EXECUTION = "Unexpected problem with test execution";
	public static final String DIALOG_SET_CATEGORY_EXPECTED_PROBLEM_TITLE = "Cannot change parameter expected status";
	public static final String DIALOG_SET_DEFAULT_VALUE_PROBLEM_TITLE = "Cannot change default value for parameter";
	public static final String DIALOG_REMOVE_PARAMETERS_PROBLEM_TITLE = "Cannot remove parameters";
	public static final String DIALOG_ADD_CONSTRAINT_PROBLEM_TITLE = "Cannot add constraint";
	public static final String DIALOG_REMOVE_CONSTRAINTS_PROBLEM_TITLE = "Cannot remove constraints";
	...
	public static final String DIALOG_RENAME_TEST_SUITE_PROBLEM = "Cannot rename test cases";
	public static final String DIALOG_REMOVE_TEST_CASES_PROBLEM_TITLE = "Cannot remove some of requested test cases";
	public static final String DIALOG_ADD_TEST_SUITE_PROBLEM_TITLE = "Cannot add test cases";
	...
	public static final String DIALOG_UPDATE_TEST_DATA_PROBLEM_TITLE = "Cannot update test data";
	public static final String DIALOG_ADD_STATEMENT_PROBLEM_TITLE = "Cannot add statement";
	public static final String DIALOG_REMOVE_STATEMENT_PROBLEM_TITLE = "Cannot remove statement";
	public static final String DIALOG_EDIT_STATEMENT_PROBLEM_TITLE = "Cannot edit statement";
	public static final String DIALOG_ADD_CHOICE_PROBLEM_TITLE = "Cannot add choice";
	public static final String DIALOG_REMOVE_CHOICE_TITLE = "Cannot remove choice";
	public static final String DIALOG_REMOVE_CHOICES_PROBLEM_TITLE = "Cannot remove some of requested patitions";
	...
	public static final String DIALOG_REMOVE_NODE_PROBLEM_TITLE = "Cannot remove element";
	public static final String DIALOG_REMOVE_NODES_PROBLEM_TITLE = "Cannot remove elements";
	...
	public static final String DIALOG_SET_PARAMETER_LINKED_PROBLEM_TITLE = "Cannot set the parameter linked";
	public static final String DIALOG_SET_PARAMETER_LINK_PROBLEM_TITLE = "Cannot set global parameter link";
	public static final String DIALOG_SET_PARAMETER_TYPE_PROBLEM_TITLE = "Cannot set parameter's type";
	public static final String DIALOG_RESET_CHOICES_PROBLEM_TITLE = "Cannot reset choices to default";
