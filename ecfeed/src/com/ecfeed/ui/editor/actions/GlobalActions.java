...
public enum GlobalActions {
	COPY(Names.COPY_ACTION_ID, Names.COPY_ACTION_NAME, Names.COPY_ACTION_SHORTCUT),
	CUT(Names.CUT_ACTION_ID, Names.CUT_ACTION_NAME, Names.CUT_ACTION_SHORTCUT),
	PASTE(Names.PASTE_ACTION_ID, Names.PASTE_ACTION_NAME, Names.PASTE_ACTION_SHORTCUT),
	INSERT(Names.INSERT_ACTION_ID, Names.INSERT_ACTION_NAME, null),
	DELETE(Names.DELETE_ACTION_ID, Names.DELETE_ACTION_NAME, Names.DELETE_ACTION_SHORTCUT),
	SELECT_ALL(Names.SELECT_ALL_ACTION_ID, Names.SELECT_ALL_ACTION_NAME, Names.SELECT_ALL_ACTION_SHORTCUT),
	UNDO(Names.UNDO_ACTION_ID, Names.UNDO_ACTION_NAME, Names.UNDO_ACTION_SHORTCUT),
	REDO(Names.REDO_ACTION_ID, Names.REDO_ACTION_NAME, Names.REDO_ACTION_SHORTCUT),
	MOVE_UP(Names.MOVE_UP_ACTION_ID, Names.MOVE_UP_ACTION_NAME, Names.MOVE_UP_ACTION_SHORTCUT),
	MOVE_DOWN(Names.MOVE_DOWN_ACTION_ID, Names.MOVE_DOWN_ACTION_NAME, Names.MOVE_DOWN_ACTION_SHORTCUT),
	EXPAND(Names.EXPAND_ACTION_ID, Names.EXPAND_ACTION_NAME, Names.EXPAND_ACTION_SHORTCUT),
	COLLAPSE(Names.COLLAPSE_ACTION_ID, Names.COLLAPSE_ACTION_NAME, Names.COLLAPSE_ACTION_SHORTCUT),
	EXPAND_COLLAPSE(Names.EXPAND_COLLAPSE_ACTION_ID, Names.EXPAND_COLLAPSE_ACTION_NAME, Names.EXPAND_COLLAPSE_ACTION_SHORTCUT),
	SAVE(Names.SAVE_ACTION_ID, Names.SAVE_ACTION_NAME, Names.SAVE_ACTION_SHORTCUT);
