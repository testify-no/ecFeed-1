...
public class ConstraintTest {
	...
	public void testEvaluate() {
		...
		assertTrue(new Constraint(new String(), falseStatement, falseStatement).evaluate(values) == EvaluationResult.TRUE);
		assertTrue(new Constraint(new String(), falseStatement, trueStatement).evaluate(values) == EvaluationResult.TRUE);
		assertTrue(new Constraint(new String(), trueStatement, trueStatement).evaluate(values) == EvaluationResult.TRUE);
		assertTrue(new Constraint(new String(), trueStatement, falseStatement).evaluate(values) == EvaluationResult.FALSE);
	}
	...
	public void testSetPremise() {
		...
		Constraint constraint = new Constraint(new String(), statement1, statement2);
	...
	public void testMentions() {
		...
		assertTrue(new Constraint(new String(), mentioningStatement, notMentioningStatement).mentions(parameter));
		assertTrue(new Constraint(new String(), mentioningStatement, notMentioningStatement).mentions(choice));

		assertTrue(new Constraint(new String(), notMentioningStatement, mentioningStatement).mentions(parameter));
		assertTrue(new Constraint(new String(), notMentioningStatement, mentioningStatement).mentions(choice));

		assertTrue(new Constraint(new String(), mentioningStatement, mentioningStatement).mentions(parameter));
		assertTrue(new Constraint(new String(), mentioningStatement, mentioningStatement).mentions(choice));

		assertFalse(new Constraint(new String(), notMentioningStatement, notMentioningStatement).mentions(parameter));
		assertFalse(new Constraint(new String(), notMentioningStatement, notMentioningStatement).mentions(choice));
	...
	public void testTupleWithNullsForValueCondition() {
		...
		Constraint constraint = new Constraint(new String(), premise, consequence);
