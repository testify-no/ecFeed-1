...
public class MethodNodeTest {
	...
	public void testAddParameter(){
		...
		MethodParameterNode parameter = new MethodParameterNode("parameter", "type1", "0", false);
		MethodParameterNode expCat = new MethodParameterNode("expCat", "type2", "0", true);
	...
	public void testAddConstraint(){
		MethodNode method = new MethodNode("name");
		Constraint constraint1 = new Constraint("name1", new StaticStatement(true), new StaticStatement(false));
		Constraint constraint2 = new Constraint("name2", new StaticStatement(true), new StaticStatement(false));
	...
	public void testGetChildren(){
		...
		ConstraintNode constraint = new ConstraintNode("constraint",
				new Constraint("constraint", new StaticStatement(false), new StaticStatement(false)));
	...
	public void testGetExpectedParametersNames(){
		MethodNode method = new MethodNode("name");
		MethodParameterNode parameter = new MethodParameterNode("parameter", "type", "0", false);
		MethodParameterNode expCat1 = new MethodParameterNode("expCat1", "type", "0", true);
		MethodParameterNode expCat2 = new MethodParameterNode("expCat2", "type", "0", true);
	...
	public void testChoiceRemoved(){
		...
		Constraint notMentioningConstraint = new Constraint("constraint", new StaticStatement(false), new StaticStatement(false));
		ConstraintNode mentioningConstraintNode = new ConstraintNode("constraint", mentioningConstraint);
		ConstraintNode notMentioningConstraintNode = new ConstraintNode("constraint", notMentioningConstraint);
