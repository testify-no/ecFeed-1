...
public class AbstractNodeTest{
	...
	public void testGetRoot(){
		...
		ConstraintNode constraint = new ConstraintNode("name", new Constraint("constraint", new StaticStatement(true), new StaticStatement(false)));
	...
	public void testSubtreeSize(){
		...
		MethodParameterNode expCat = new MethodParameterNode("name2", "type", "0", true);
		expCat.setDefaultValueString("0");
		ConstraintNode constraint = new ConstraintNode("name", new Constraint("name", new StaticStatement(true), new StaticStatement(false)));
		TestCaseNode testCase = new TestCaseNode("name", new ArrayList<ChoiceNode>());
		ChoiceNode choice = new ChoiceNode("name", "0");
